...
export function CCTVFeedSection({ onDetectionClick, fullView = false, onNewEvidence }: CCTVFeedSectionProps) {
  ...
  const cctvFeeds = [
    ...
    },
    {
      ...
      threatLevel: 'medium',
      youtubeId: 'eO19UTm93GQ', // Main Street
      videoUrl: '',
      supportsWeaponDetection: true
    },
    {
      ...
      threatLevel: 'high',
      youtubeId: 'ixS3Ymux9tE', // East Park
      videoUrl: '',
      supportsWeaponDetection: true
    },
    {
      id: 4,
      name: 'Helmet Camera Footage',
      location: 'Urban Patrol',
      status: 'active',
      lastActivity: 'Live Stream',
      detections: ['Weapon'],
      threatLevel: 'low',
    ...
    },
    {
      ...
      location: 'Ordinance Factory',
      status: 'active',
      lastActivity: 'Live Stream',
      detections: ['person', 'weapon'],
      threatLevel: 'high',
      youtubeId: 'jyLwFS6dCAg', // Weapon Manufacturing
      videoUrl: '',
      supportsWeaponDetection: true
    },
    {
      ...
      detections: ['person', 'weapon'],
      threatLevel: 'high',
      youtubeId: 'r-XPPUnne6I', // Training School
      videoUrl: '',
      supportsWeaponDetection: true
    }
  ];
