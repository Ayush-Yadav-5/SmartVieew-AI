...
export function Header({ activeTab, onTabChange, onLogout }: HeaderProps) {
  ...
  return (
    <header className="bg-[#0C1428] border-b border-violet-900/40 sticky top-0 z-40 backdrop-blur-lg bg-opacity-95">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          {/* Logo and Project Name */}
          <div className="flex items-center space-x-3">
            <div className="flex items-center justify-center w-10 h-10 bg-gradient-to-br from-violet-500 to-indigo-600 rounded-lg shadow-lg shadow-violet-500/30">
              <Shield className="w-6 h-6 text-white" />
            </div>
            <div>
              <h1 className="text-white font-bold text-xl tracking-tight">SmartVieew AI</h1>
                    ...
                    <div className="absolute right-0 mt-2 w-64 bg-[#1A1F2E] border border-gray-700 rounded-lg shadow-xl z-50">
                      <div className="p-4 border-b border-gray-700">
                        ...
                        <p className={`text-xs mt-1 capitalize ${
                          currentUser.userType === 'admin' ? 'text-rose-400' : 'text-violet-400'
                        }`}>
