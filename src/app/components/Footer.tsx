...
export function Footer() {
          ...
          <div>
            ...
            <div className="space-y-6 text-gray-300">
              <div>
                ...
                <p className="text-sm">SmartVieew AI is an advanced autonomous urban intelligence platform designed for law enforcement and security organizations.</p>
              </div>
              <div>
          ...
          <div>
            ...
            <div className="space-y-6 text-gray-300">
              <div>
                ...
                <p className="text-sm">SmartVieew AI collects and processes surveillance data, user credentials, and location information solely for law enforcement and public safety purposes.</p>
              </div>
              <div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-lg p-4">
                    ...
                    <p className="text-sm">support@smartvieew.ai (Response within 4 hours)</p>
                  </div>
                </div>
              </div>
              <div>
  ...
  return (
    <>
      <footer className="bg-[#050A18] border-t border-gray-700 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {/* Brand & Description */}
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center space-x-3 mb-4">
                <div className="flex items-center justify-center w-8 h-8 bg-gradient-to-br from-violet-500 to-indigo-600 rounded-lg">
                  <Shield className="w-5 h-5 text-white" />
                </div>
                <h3 className="text-xl font-bold text-white">SmartVieew AI</h3>
              </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="text-white font-medium">control@smartvieew.gov.in</div>
            ...
            <div>
              ...
              <div className="space-y-3">
                <button 
                  ...
                  className="flex items-center space-x-2 text-gray-400 hover:text-violet-400 transition-colors w-full text-left"
                >
          ...
          <div className="border-t border-gray-700 mt-8 pt-8">
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="text-gray-400 text-sm mb-4 md:mb-0">
                © 2026 SmartVieew AI. All rights reserved. | Building the Operating System for Future Cities.
              </div>
      ...
      {openDialog && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-[#050A18] border border-white/10 rounded-2xl max-w-3xl w-full max-h-[80vh] overflow-y-auto">
            <div className="sticky top-0 bg-[#050A18] border-b border-white/10 p-6 flex items-center justify-between">
            ...
            <div className="sticky bottom-0 bg-[#050A18] border-t border-white/10 p-6 flex justify-end">
              <button 
                onClick={closeDialog}
