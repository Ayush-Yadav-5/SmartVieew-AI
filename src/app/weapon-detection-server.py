"""
SmartVieew AI - Dangerous Weapon Detection Server (Fixed)
===========================================================
...
VIDEO_SOURCES = {
    1: 'https://youtube.com/watch?v=AiJtHubk4IQ',  # Railway/Traffic footage
    2: 'https://youtu.be/eO19UTm93GQ?si=pmqEdBJPd5hSKU3a',  # Main Street
    3: 'https://youtube.com/shorts/ixS3Ymux9tE',  # East Park
    4: 'https://youtube.com/shorts/YIvwiih1DWk',  # Metro/urban footage
    5: 'https://youtube.com/shorts/jyLwFS6dCAg',  # Weapon Manufacturing
    6: 'https://www.youtube.com/shorts/r-XPPUnne6I',  # Training School
}
...
def index():
    """API documentation"""
    return jsonify({
        'service': 'SmartVieew Weapon Detection API',
        'version': '2.0',
        'status': 'operational',
        'endpoints': {
...
if __name__ == '__main__':
    print("=" * 70)
    print("      SmartVieew AI - Weapon Detection Server")
    print("=" * 70)
